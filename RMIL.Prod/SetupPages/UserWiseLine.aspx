<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Main.Master" AutoEventWireup="true" CodeBehind="UserWiseLine.aspx.cs" Inherits="RMIL.Prod.SetupPages.UserWiseLine" %>
                    ...
                    <div class="col-md-12">
                        <div class="panel panel-default">
                            <div class="panel-heading" style="background-color: #82e0aa">
                                <div class="pull-left"><strong>User Wise Line Setup</strong></div>
                            ...
                            <div class="panel-body" style="background-color: #99ccff">
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-horizontal">
                                            <div class="form-group">
                                                <label class="control-label col-lg-4">Production Line</label>
                                                <div class="col-lg-8">
            ...
            <section class="wrapper">
                <div class="row">
                    <div class="col-md-12">
                        <div class="panel panel-default">
                            <div class="panel-heading" style="background-color: #82e0aa">
                                <div class="pull-left"><strong>User Wise Line Setup List</strong></div>
                                <div class="clearfix"></div>
                            </div>
                            <div class="panel-body" style="background-color: #99ccff">
                                <div class="col-md-12">
                                    <asp:GridView ID="gvUserLine" CssClass="table table-striped dt-responsive display"
                                        ...
                                        DataKeyNames="RmUwLId" runat="server" OnPageIndexChanging="gvUserLine_PageIndexChanging">
                                        <Columns>
                                            <asp:BoundField HeaderText="ID" DataField="RmUwLId">
                                            ...
                                            <asp:TemplateField HeaderText="Edit">
                                                <ItemTemplate>
                                                    <asp:ImageButton ID="btnEditUserLine" runat="server" ImageUrl="~/Images/edit.png" ToolTip="Edit Record"
                                                        Width="22px" Height="22px" CommandArgument='<%# Eval("RmUwLId")%>' OnClick="btnEditUserLine_Click" CausesValidation="False" />
                                                </ItemTemplate>
                                                <HeaderStyle CssClass="HeaderCenterStyle"></HeaderStyle>
                                                <ItemStyle CssClass="HeaderCenterStyle"></ItemStyle>
                                            </asp:TemplateField>
