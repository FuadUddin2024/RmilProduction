...
{
    public partial class QcSwitchSetup : System.Web.UI.Page
    {
        #region Page Load
        ...
        private void LoadQcSwitchGridView()
        {
            var qcsList = new QcSwitchDa(true).GetQcSwitchList();
            gvQcTestSwitch.DataSource = qcsList;
            gvQcTestSwitch.DataBind();
        }
        ...
        protected void gvQcTestSwitch_PageIndexChanging(object sender, GridViewPageEventArgs e)
        {
            gvQcTestSwitch.PageIndex = e.NewPageIndex;
            this.LoadQcSwitchGridView();
        }
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            if (Session[WebUtility.SessionCurrentUserObj] != null)
            {
                ...
                try
                {
                    QcSwitch qcSwitch = new QcSwitch();

                    var qc = new QcSwitchDa(false).GetGroupWiseQcSwitchByStpsId(Convert.ToInt32(ddlCategory.SelectedValue), Convert.ToInt32(ddlFromQc.SelectedValue), Convert.ToInt32(ddlToQc.SelectedValue));
                    if (qc != null)
                    {
                    ...
                    qcSwitch.CategoryId = Convert.ToInt32(ddlCategory.SelectedValue);
                    ...
                    qcSwitch.FromStId = Convert.ToInt32(ddlFromQc.SelectedValue);
                    ...
                    qcSwitch.ToStId = Convert.ToInt32(ddlToQc.SelectedValue);

                    qcSwitch.EntryBy = currentUser.UserId;
                    qcSwitch.EntryDate = DateTime.Now;
                    qcSwitch.EntryPC = WebUtility.GetIpAddress();

                    new QcSwitchDa(false).Insert(qcSwitch);
        ...
        protected void btnUpdate_Click(object sender, EventArgs e)
        {
            if (Session[WebUtility.SessionCurrentUserObj] != null)
            {
                ...
                try
                {
                    if (Session["swId"] != null)
                    {
                        int swId = Convert.ToInt32(Session["swId"]);
                        var selecteddata = new QcSwitchDa(false).GetQcSwitchById(swId);
                        ...
                        new QcSwitchDa(false).Update(selecteddata);
        ...
        protected void btnEditQcSwitch_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                int swId = Convert.ToInt32(((ImageButton)sender).CommandArgument);
                Session["swId"] = swId;
                var selecteddata = new QcSwitchDa(false).GetQcSwitchById(swId);
        ...
        protected void btnDeleteQcSwitch_Click(object sender, EventArgs e)
        {
            try
            {
                int swId = Convert.ToInt32(((ImageButton)sender).CommandArgument);
                var selecteddata = new QcSwitchDa(false).GetQcSwitchById(swId);
                new QcSwitchDa(false).Delete(selecteddata);
