...
namespace RMIL.Prod.DAL
{
    public class RmilProdDetailsDa : BaseDa
    {
        ...
        public List<vw_ProductDistributionHistoryV> GetModelInfoByBarCodeNewV(string barCode)
        {
            List<vw_ProductDistributionHistoryV> qList = ObjRmilcsDbEntities.vw_ProductDistributionHistoryV.Where(c => c.DBarcode == barCode).ToList();
            return qList;
        }
