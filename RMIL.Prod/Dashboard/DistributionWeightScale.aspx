<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Main.Master" AutoEventWireup="true" CodeBehind="DistributionWeightScale.aspx.cs" Inherits="RMIL.Prod.Dashboard.DistributionWeightScale" %>
...
<script type="text/javascript">
    ...
    function FetchAllTheDataDay() {
        ...
        $.ajax({
            url: 'DistributionWeightScale.aspx/GetALLDayShiftData',
            type: 'POST',
                ...
                if (response.d) {
                    ...
                    if (data.ShiftData && data.ShiftData.length > 0) {
                        ...
                        data.ShiftData.forEach(function (item) {
                            ...
                            html += `
                                <tr>
                                    <td style="font-size: 21px;"><b>${item.FromDepotName}</b></td>
                                    <td style="font-size: 21px;"> <b>${item.ToDepotName}</b></td>
    ...
    function FetchAllTheDataNight() {
        ...
        $.ajax({
            url: 'DistributionWeightScale.aspx/GetALLNightShiftData',
            type: 'POST',
            contentType: 'application/json; charset=utf-8',
            dataType: 'json',
            data: '{}',
            ...
            <section class="wrapper">
                <div class="row">
                    <div class="col-md-6">
                        <div class="panel panel-default">
                            <div class="panel-heading" style="background-color: #82e0aa">
                                <div class="pull-left"><strong>Daily Day Shift Distribution Summary</strong></div>
                                <div class="clearfix"></div>
                            </div>
                            <div class="panel-body" style="background-color: #99ccff">
                                <div class="col-md-12">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <thead>
                                    <tr class="gray-bg">
                                        <th style="font-size: 21px;"><b>From Depot Name </b></th>
                                        <th style="font-size: 21px;"><b>To Depot Name</b></th>
                                        <th style="font-size: 21px;"><b>Total Depo Out</b></th>
                                    </tr>
                                    </thead>
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading" style="background-color: #82e0aa">
                                <div class="pull-left"><strong>Daily Night Shift Distribution Summary</strong></div>
                                <div class="clearfix"></div>
                            </div>
                            <div class="panel-body" style="background-color: #99ccff">
                               <div class="col-md-12">
