...
{
    public partial class DistributionWeightScale : System.Web.UI.Page
    {
        ...
        [WebMethod]
        public static DayShiftViewModelDistribution GetALLDayShiftData()
        {
            RMILDashboardDa DayshiftData = new RMILDashboardDa();
            var tableDetails = DayshiftData.GetDayShiftDataDistribution();

            return new DayShiftViewModelDistribution
            {
        ...
        [WebMethod]
        public static NightShiftViewModelDistribution GetALLNightShiftData()
        {
            RMILDashboardDa DayshiftData = new RMILDashboardDa();
            var tableDetails = DayshiftData.GetNightShiftDataDistribution();

            return new NightShiftViewModelDistribution
            {
                ShiftData = tableDetails,
                TotalProduction = tableDetails.Sum(x => x.TotalProduction)
            };
