<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPages/Main.Master" CodeBehind="RmilDistributionReturn.aspx.cs" Inherits="RMIL.Prod.Distribution.RmilDistributionReturn" %>
                    ...
                    <div class="col-md-12">
                        <div class="panel panel-default">
                            <div class="panel-heading" style="background-color: #82e0aa">
                                <div class="pull-left"><strong>Depo Return</strong></div>
                                        ...
                                        <div class="form-horizontal">
                                            <div class="form-group">
                                                ...
                                                <asp:TextBox ID="ddlmaster"
                                                   ...
                                                   <%-- <asp:TextBox ID="ddlmaster" runat="server" class="form-control" OnSelectedIndexChanged="txtBarCode_TextChanged" AutoPostBack="True"></asp:TextBox>--%>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-md-3">
                                        <div class="form-horizontal">
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-8">
                                                     <asp:TextBox ID="ddldealercode" runat="server" class="form-control"></asp:TextBox>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-horizontal">
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-8">
                                                     <asp:TextBox ID="ddldeponame" runat="server" class="form-control"></asp:TextBox>
                                                </div>
                                            </div>
                                        </div>
                               </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                      <asp:GridView ID="gvCart" runat="server" AutoGenerateColumns="false"
                                        ...
                                        <Columns>
                                            <asp:BoundField DataField="BoxBarCode" HeaderText="Master Barcode" />
                                            <asp:BoundField DataField="ProductModelBarcode" HeaderText="Product Barcode" />
                                            <asp:ButtonField CommandName="DeleteRow" Text="Remove" ButtonType="Button" />
                                        </Columns>
                                    </asp:GridView>
                                    </div>
                                </div>
                                <div class="row" runat="server" id="submitall">
                                    <div class="col-md-12">
                                        <asp:Button ID="btnreturnsubmit" runat="server" Text="Submit All" OnClick="btnSubmit_Click" />
                                    </div>
                                </div>
                                  <%--     
