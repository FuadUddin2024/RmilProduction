<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Main.Master" AutoEventWireup="true" CodeBehind="RmilQcWeighingScale.aspx.cs" Inherits="RMIL.Prod.QC.RmilQcWeighingScale" %>
                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body" style="background-color: #99ccff">
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-horizontal">
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-8">
                                                    <%--OnTextChanged="txtBarCode_TextChanged" AutoPostBack="True"--%>
                                    ...
                                    <div class="col-md-6" runat="server" id="pnlProb">
                                        <div class="form-horizontal">
                                            <div class="form-group">
                                                <label class="control-label col-lg-4">Problem Name</label>
                                                <div class="col-lg-8">
                                                     <asp:TextBox ID="ddlproblem" runat="server" class="form-control"></asp:TextBox>
                                ...
                                <div class="row" style="float:right">
                                    ...
                                    <asp:Button ID="btnQcSave" runat="server" Text="Save" ValidationGroup="vgSubmit"
                                        OnClick="btnQcSave_Click" class="btn btn-danger"/>
                                   <asp:Button ID="btnProbSave" runat="server" Text="SaveProb" ValidationGroup="vgSubmit"
                                        OnClick="btnProbSave_Click" class="btn btn-danger" Visible="False"/>
                                  <asp:Button ID="btnShow" runat="server" Text="Show" 
                                        OnClick="btnShow_Click" class="btn btn-success" />
                                  <asp:Button ID="btnHide" runat="server" Text="Hide" Visible="False"
                                        OnClick="btnHide_Click" class="btn btn-success" />
                                        </div>
                                       <%-- <div class="col-md-6">
                                            <div class="form-horizontal">
                                                <div class="form-group">
