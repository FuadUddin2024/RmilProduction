<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Main.Master" AutoEventWireup="true" CodeBehind="RmilQcWeighingScaleRecheck.aspx.cs" Inherits="RMIL.Prod.QC.RmilQcWeighingScaleRecheck" %>
                    ...
                    <div class="col-md-12">
                        <div class="panel panel-default">
                            <div class="panel-heading" style="background-color: #82e0aa">
                                <div class="pull-left"><strong>QC ReTest Info</strong></div>
                            ...
                            <div class="panel-body" style="background-color: #99ccff">
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-horizontal">
                                            <div class="form-group">
                                                <label class="control-label col-lg-4">Exists Problem</label>
                                                <div class="col-lg-8">
