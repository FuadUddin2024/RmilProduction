<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Main.Master" AutoEventWireup="true" CodeBehind="RptBarcode.aspx.cs" Inherits="RMIL.Prod.Reports.RptBarcode" %>
                            ...
                            <telerik:RadGrid AutoGenerateColumns="false" ID="gvBarcode" CssClass="table table-condensed table-striped table-hover table-bordered pull-left"
                                ...
                                <MasterTableView AutoGenerateColumns="false" DataKeyNames="RmPdId" EditMode="InPlace" AllowFilteringByColumn="True"
                                    ...
                                    <Columns>
                                        ...
                                        <telerik:GridBoundColumn DataField="RmPmId" HeaderText="PMID" SortExpression="RmPmId"
                                            UniqueName="RmPmId" FilterControlWidth="105px" AutoPostBackOnFilter="false" CurrentFilterFunction="Contains"
                                            FilterDelay="4000" ShowFilterIcon="True">
                                        </telerik:GridBoundColumn>
                                        <telerik:GridBoundColumn FilterControlWidth="105px" DataField="DBarcode" HeaderText="Barcode No"
